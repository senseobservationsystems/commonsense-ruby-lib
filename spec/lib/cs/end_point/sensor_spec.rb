  ...
  module EndPoint
    describe Sensor do
      ...
      describe "copy_data" do
        ...
        it 'should also parse interval parameter' do
          @session_a.should_receive(:get)
            .with("/sensors/1/data.json", {:page=>0, :per_page=>1000, :start_date=>1402032192.0, :end_date=>1402032200.0, sensor_id: 1, interval: 60})

          @sensor_b.copy_data(@sensor_a, start_date: 1402032192, end_date: 1402032200, interval: 60)
